...
parser.add_argument("--folder", type=str, default="turbot_images", help="Folder that contain image")
parser.add_argument("--dest", type=str, default="turbot_dataset", help="Destination")
